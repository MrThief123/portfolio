      ...
      <div className="relative max-w-[1600px] mx-auto px-6 md:px-12">
        ...
        >
          <a
            ...
            data-cursor="hover"
            className="group inline-flex items-start gap-4 font-display font-black text-[11vw] md:text-[8vw] leading-none tracking-tighter text-white hover:text-cyan-400 transition-colors duration-500"
          >
            Let&apos;s Talk
        ...
        <div className="mt-24 grid grid-cols-2 md:grid-cols-2 gap-20">
